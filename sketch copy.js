...
function setup() {
  ...
  checkScaleAuto = createCheckbox('Automate Scale', false);
  ...
  checkBG = createCheckbox ('Enable Background',true);
  checkBG.position(sliderSecondCol,sliderFirstRow+20);
  checkBgHue = createCheckbox('Hue Automation', false)
  checkBgHue.position(sliderSecondCol,sliderFirstRow+40)
  checkBgSat = createCheckbox('Saturation Animation', false)
  checkBgSat.position(sliderSecondCol,sliderFirstRow+60)
  checkBgBri = createCheckbox('Brightness Automation', false)
  ...
  checkFillHue = createCheckbox('Hue Automate', false);
  checkFillHue.position(sliderSecondCol ,sliderFirstRow+280);
  checkFillSat = createCheckbox('Saturation Automate');
  checkFillSat.position(sliderSecondCol,sliderFirstRow+300);
  checkFillBri = createCheckbox('Brightness Automate');
  checkFillBri.position(sliderSecondCol,sliderFirstRow+320);
  checkFillAlpha = createCheckbox('Alpha Automate',false);
  ...
  checkPositionXAuto = createCheckbox('X Position Automate', false)
  checkPositionXAuto.position(sliderSecondCol,sliderFirstRow+440)
  checkPositionYAuto = createCheckbox('Y Position Automate', false);
  ...
  totalShapes= map(canvasXY,724,1110,52,80);
